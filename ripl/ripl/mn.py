...
"""
from ripl.dctopo import FatTreeTopo, FatTreeTopo1, BCubeTopo, TestBedTopo #, VL2Topo, TreeTopo

topos = {'ft': FatTreeTopo, 'ft1': FatTreeTopo1, 'bc': BCubeTopo, 'tb': TestBedTopo}
